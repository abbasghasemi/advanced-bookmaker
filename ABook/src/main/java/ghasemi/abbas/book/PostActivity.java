...
import ghasemi.abbas.book.components.Button;
import ghasemi.abbas.book.components.GifView;
import ghasemi.abbas.book.components.Slider;
import ghasemi.abbas.book.components.VideoPlayer;
    ...
    private void startPars(String src) {
        ...
        switch (type) {
            case "img": {
                ...
                if (src.startsWith("[z]")) {
                    src = src.substring(3);
                    Intent intent = new Intent(PostActivity.this, ghasemi.abbas.book.components.ImageView.class);
