...
import ghasemi.abbas.book.general.CustomFonts;
import ghasemi.abbas.book.general.MarketConfiguration;

public class BuildApp {

        public static MarketConfiguration MARKET_TYPE = MarketConfiguration.CAFE_BAZAAR; //CAFE_BAZAAR MYKET
