package ghasemi.abbas.book.support.medialoader;

import android.content.Context;

import ghasemi.abbas.book.support.medialoader.data.file.naming.FileNameCreator;
import ghasemi.abbas.book.support.medialoader.data.file.naming.Md5FileNameCreator;
...
public final class DefaultConfigFactory {
    ...
    public static File createCacheRootDir(Context context) {
        return FileUtil.getDiskCacheDir(context);
    }
