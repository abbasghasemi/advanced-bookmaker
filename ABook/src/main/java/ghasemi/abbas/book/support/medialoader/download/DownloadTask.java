package ghasemi.abbas.book.support.medialoader.download;

import ghasemi.abbas.book.support.medialoader.DownloadManager;
...
public class DownloadTask implements Runnable {
    ...
    private final UrlDataSource mUrlDataSource;
