...
import ghasemi.abbas.book.support.medialoader.tinyhttpd.interceptor.AuthInterceptor;
import ghasemi.abbas.book.support.medialoader.tinyhttpd.interceptor.Interceptor;
import ghasemi.abbas.book.support.medialoader.tinyhttpd.interceptor.InterceptorChainImpl;
import ghasemi.abbas.book.support.medialoader.tinyhttpd.interceptor.LoggingInterceptor;
...
public abstract class TinyHttpd {
    ...
    private final DispatchHandler mDispatchRunnable;

    private final EchoTester mEchoTester;

    private final List<Interceptor> mInterceptors = Collections.synchronizedList(new LinkedList<Interceptor>());
